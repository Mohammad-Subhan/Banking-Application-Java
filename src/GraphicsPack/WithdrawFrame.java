...
public class WithdrawFrame implements ActionListener {
    ...
    public WithdrawFrame() {
        ...
        // ------------------ Main Label -----------------------
        mainLabel.setText("Withdraw Amount");
        ...
        // --------------------- Withdraw button ----------------------
        withdrawButton.setBounds(160, 240, 100, 44);
        withdrawButton.setText("Withdraw");
        withdrawButton.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        withdrawButton.setFocusable(false);
        withdrawButton.addActionListener(this);
        withdrawButton.setButtonColor(UIUtils.SC_COLOR);
        ...
        if (e.getSource() == withdrawButton) {
            ...
            if (amount.equals("") || amount.equals("Amount")) {
                ...
                if (Double.parseDouble(amount) <= AccountClass.account.getBalance()) {
                    ...
                    AccountClass.account.CashWithdrawl(Double.parseDouble(amount));
                    ConfirmationDialog("Amount Withdrawn Successfully");
